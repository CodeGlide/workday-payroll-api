...
func Post_payrollinputsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/payrollInputs", cfg.BaseURL)
...
func CreatePost_payrollinputsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_payrollInputs",
		mcp.WithDescription("Creates payroll inputs."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_payrollinputsHandler(cfg),
	}
}
